...
value_counts = train["A1"].value_counts(normalize=True, dropna=False)
print("\n", value_counts)
stats = []
...
stats_columns = ['Feature', 'Unique_values', 'Percent_missing', 'Percentage_biggest', 'type']
stats_df = pd.DataFrame(stats, columns = stats_columns)
stats_df.sort_values('Percent_missing', ascending=False)[:10]
print(stats_df)
...
##### xgb
xgb_params = {'eta': 0.005, 'max_depth': 11, 'subsample': 0.85, 'colsample_bytree': 0.7,
